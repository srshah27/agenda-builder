import {
  Box, Flex, useColorModeValue, Drawer, DrawerContent, Text, useDisclosure, Stack, HStack, Input
} from '@chakra-ui/react'
import {IconButton, CloseButton, Button} from '@chakra-ui/react'
...
export default function SimpleSidebar({children, updateRefresh}) {
  ...
  return (<Box minH="100%" bg={useColorModeValue('gray.100', 'gray.900')}>
        <SidebarContent
            onClose1={() => onClose}
