              ...
              <div className="relative flex items-start space-x-3">
                ...
                <div className="md:w-96 flex-1 max-sm:w-44">
                  <div>
                    ...
                    <div className={` absolute font-medium sm:hidden text-gray-900  ${timeline[version].title.length > 22?'top-0' : 'top-2.5'}`}>
                      {timeline[version].title}
                    </div>
                    <p className="font-medium text-gray-900 max-sm:hidden">{timeline[version].description}</p>
                  </div>
                </div>
              </div>
            </div>
