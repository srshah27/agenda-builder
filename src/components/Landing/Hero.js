...
function Hero() {
  return (
    <div
      className="flex w-screen flex-col bg-gradient-to-br from-[#4379e5] via-[#faf6f7] to-[#aec6f6] supports-[min-height:100dvh]:min-h-[100dvh] md:grid md:grid-cols-2 lg:grid-cols-[60%_40%]"
      id="home"
    >
