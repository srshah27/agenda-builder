...
function Hero() {
  return (
    <div
      ...
      id="home"
    >
      <div className="relative flex flex-1 flex-col justify-center px-5 pt-8 text-[#FE7600] dark:text-[#CDE9FF] md:px-6 md:py-[22px] lg:px-8">
        ...
        <div className="flex-col text-center text-[32px] leading-[1.2] md:flex md:text-left md:text-[40px]">
          <h1 className="font-extrabold text-[#FE7600] dark:text-[#CDE9FF]">
