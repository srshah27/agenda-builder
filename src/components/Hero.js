  ...
  return (
    ...
    <div className="absolute w-screen h-screen left-0 top-0 -z-50 overflow-x-hidden">
      <div className={styles.backbg}>
        ...
        <div className={styles.wave}></div>
        <div className={styles.wave}></div>
        <div className="md:pl-36 md:pt-52 pl-10 pt-48 text-gray-100 text-3xl md:text-7xl font-mono md:text-left text-center ">Welcome to <br/> Agenda Builder!</div>
        <div className="md:pl-36 pt-8 pl-10 text-gray-100  text-xl md:text-3xl font-mono md:text-left text-center ">Add tasks and collaborate with your colleagues. <br/> Let&aposs get oraganized together.</div>
        <Image
        src="/svg/track.svg"
