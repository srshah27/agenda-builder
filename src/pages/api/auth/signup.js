...
export default async function handler(req, res) {
  ...
  let image = `https://api.dicebear.com/5.x/initials/png?seed=${name}&radius=50&backgroundColor=27d3d5,3ea7da,9d8eef&backgroundType=gradientLinear&fontFamily=Verdana&fontSize=46`
  try {
