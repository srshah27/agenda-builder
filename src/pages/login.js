          ...
          <div className="mx-auto my-0 shadow-[0px_0px_50px_2px_rgb(0,0,0,0.2)] w-96 max-w-lg  py-[25px] px-[40px] rounded-sm bg-white">
            ...
            <div className="">
              <form className="block mt-0 w-50" onSubmit={formik.handleSubmit}>
                ...
                <button className="w-full h-10 my-2 font-mono font-bold text-gray-100 rounded-md btn-active bg-primary" type='submit'>
                  Log In
                </button>
                </form>
                ...
                <div className="inline mx-10 text-sm text-gray-400">
                  ...
                  <RxDotFilled className="inline text-gray-800" /> <Link className='' href={'/signup'}>Sign Up!</Link>
                </div>
