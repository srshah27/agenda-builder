  ...
  return (
    ...
    <div className='flex items-center justify-center text-3xl md:text-4xl text-accent font-mono font-bold'>
      ...
      <section className="w-full p-5">
        <div className="mx-auto my-0 w-96 max-w-lg shadow-lg py-[25px] px-[40px] rounded-sm bg-white">
            ...
            <div className="  ">
              <form className="block mt-0 w-50  ">
                ...
                />
                <button className="btn btn-sm btn-active btn-accent w-full h-10 rounded-sm font-mono my-2">Log In</button>
                ...
                <div className=" inline font-bold text-slate-600">Continue with Google</div> 
                </button>
                <div className="divider mt-6 h-1"></div>
                <div className ="inline mx-10 text-gray-400 text-sm"> Don't have an account? <RxDotFilled className ="inline"/> Sign Up!   </div>
